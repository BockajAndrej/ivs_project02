...
namespace UnitTestCalculator
{
    ...
    public class UnitTest1
    {
        ...
        {   
            ...
            //Assert.ThrowsException<NegativeRootException>(() => root.Exponentiation(-5.123456789101112131415161718m, 6m));
            //Assert.ThrowsException<NegativeRootException>(() => root.Exponentiation(6m, -5.123456789101112131415161718m));
            //Assert.ThrowsException<NegativeRootException>(() => root.Exponentiation(-5.123456789101112131415161718m, 0m));
            //Assert.AreEqual(-1.723935551553132419949721178881m, root.Exponentiation(-5.123456789101112131415161718m, 3), delta: 0.00000000000000000000000001m);
            //Assert.AreNotEqual(-1.723935551554132419949721178881m, root.Exponentiation(-5.123456789101112131415161718m, 3), delta: 0.00000000000000000000000001m);
            //Assert.AreEqual(2.1580105439510335m, root.Exponentiation(101m, 6m), delta: 0.00000000000000000000000001m);
